...
from app.llm.factory.factory import create_adapter
...
class TestCaseGenerator:
    ...
    async def generate_test_cases(
        ...
        """
        self.logger.info(
            f"Generating {request.num_test_cases} test cases for "
...
4. Provide clear reasoning for your test case generation approach
...
- question_slug: normalized problem identifier (appropriate to the LeetCode problem format f.e. "two-sum")
- test_case: input data in proper format
- expected_result: correct output for the input
- description: brief explanation of what this test case covers (optional)
